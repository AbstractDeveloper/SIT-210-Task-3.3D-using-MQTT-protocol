/*
 * Task - To receive the wave detected by the sensor
 * By - Sahil Guglani
 */
...
//sensitive data or wifi credentials
char ssid[] = "iphone";    // your network SSID (name)
char pass[] = "asdfghjkl";    // your network password (use for WPA, or use as key for WEP)
